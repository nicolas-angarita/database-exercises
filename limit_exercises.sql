...
/* Alselm Cappello, Utz Mandell, Bouchung Schreiter, Baocai Kushner, Petter Stroustrup are the 5 names of the employees*/
...
/* The releationship between LIMIT and OFFSET are that you input the limit you want from your dataset and you are offsetting the output you want in a chronological order. */
